                                ...
                                {['right'].map((anchor) => (
                                    <React.Fragment key={anchor}>
                                        <div className="ml-auto">
                                            <IconButton onClick={toggleDrawer(anchor, true)} edge="start" className={classes.menuButton} size="large" variant="contained" color="inherit" aria-label="menu">
                                                <TelegramIcon />
                                            </IconButton>
                                        </div>
                                        {/* <Button onClick={toggleDrawer(anchor, true)}>{anchor}</Button> */}
                                        ...
                                        >
                                            <div
                                                className={clsx(classes.rightList)}
                                                role="presentation"
                                            // onClick={toggleDrawer(anchor, false)}
                                            // onKeyDown={toggleDrawer(anchor, false)}
                                            >
                                                <Button style={{ position: 'absolute', right: '50px', top: '10px' }} variant="contained" color="secondary" onClick={toggleDrawer(anchor, false)}><CloseIcon /></Button>
                                                <Massage />
                                            </div>
                                        </SwipeableDrawer>
                                    </React.Fragment>
