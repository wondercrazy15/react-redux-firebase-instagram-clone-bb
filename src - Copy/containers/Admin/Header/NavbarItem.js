                    ...
                    {['left'].map((anchor) => (
                        <React.Fragment key={anchor}>
                            ...
                            >
                                ...
                                >
                                    <Button className="my-2" fullWidth variant="contained" onClick={() => history.push('/admin/users')}>
                                        All Users
                                    </Button>
                                    <Button className="my-2" fullWidth variant="contained" onClick={() => history.push('/admin/posts')}>
                                        All Posts
                                    </Button>
                                </div>
                            </SwipeableDrawer>
